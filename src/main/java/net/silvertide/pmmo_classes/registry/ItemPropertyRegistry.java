...
public class ItemPropertyRegistry {
    private static final List<InsigniaColor> RANKABLE_COLORS = Arrays.asList(InsigniaColor.RED, InsigniaColor.GREEN, InsigniaColor.PURPLE, InsigniaColor.WHITE);
